...
# compensate for that but https://www.zsh.org/mla/workers/2022/msg00655.html
# original:
...
git_prompt()
{
    if check_command git && [ ! -e $HOME/.git_banned ] || echo "$PWD" | grep -viqf ${HOME}/.git_banned 2>/dev/null
    then
